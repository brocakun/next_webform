...
export type WebformElementProps = {
    ...
    setValue?: (value: string | boolean | Array<string | WebformDataType> | WebformDataType | HTMLInputElement) => void;
...
export type validateFn = (data: WebformDataType) => ErrorObjectType | Promise<ErrorObjectType> | null;
...
export type setDataFn = (fn: React.Dispatch<React.SetStateAction<WebformDataType>>) => void;
export type setStatusFn = React.Dispatch<React.SetStateAction<StatusType>>;
export type WebformDataType = {
    [key: string]: string | WebformDataType | Array<string | WebformDataType> | null;
};
export type StatusType = 'error' | 'success' | undefined;
export type validatorFn = (i: string | WebformDataType | (string | WebformDataType)[]) => boolean;
