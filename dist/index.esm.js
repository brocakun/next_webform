...
var WebformContext = /*#__PURE__*/React.createContext(null);
...
var resolveWebformSubmission = function resolveWebformSubmission(id, sid, locale, drupal, fetchOptions) {
  try {
    var url = drupal.buildUrl("/webform/" + id + "?_format=json");
    // Suport for Multilanguage context.
    var elementsUrl = drupal.buildUrl((locale !== '' ? "/" + locale : '') + "/webform_rest/" + id + "/elements?_format=json");
    var submissionUrl = drupal.buildUrl("/webform_rest/" + id + "/submission/" + sid + "?_format=json");
...
var resolveWebformContent = function resolveWebformContent(id, locale, drupal, fetchOptions) {
  try {
    var url = drupal.buildUrl("/webform/" + id + "?_format=json");
    // Suport for Multilanguage context.
    var elementsUrl = drupal.buildUrl((locale !== '' ? "/" + locale : '') + "/webform_rest/" + id + "/elements?_format=json");
...
var updateNestedObjectDefaultValue = function updateNestedObjectDefaultValue(obj, keyToFind, newValue) {
...
var withStates = function withStates(WrappedComponent) {
  return function WebformElementWithStates(props) {
    ...
    var _useContext = useContext(WebformContext),
...
var WebformElementWrapper = function WebformElementWrapper(_ref) {
  ...
  var labelClasses = classNames(labelProps['className'], {
    'required-field': isRequired,
    'visually-hidden': labelDisplay === 'invisible'
  });
  var descriptionClasses = classNames(descriptionProps['className'], {
    'visually-hidden': descriptionDisplay === 'invisible'
  });
  var labelElement = /*#__PURE__*/jsx("label", _extends({}, labelProps, {
...
var WebformFieldsetWrapper = function WebformFieldsetWrapper(_ref) {
  ...
  var labelElement = /*#__PURE__*/jsx("legend", _extends({}, labelProps, {
    className: labelClasses,
    children: label
  }));
...
var withWrapper = function withWrapper(EnhancedComponent, customConfig) {
  ...
  return function WebformElementWithWrapper(props) {
    ...
    var hasValidError = typeof error === 'string' || /*#__PURE__*/React.isValidElement(error);
...
var WebformAutocomplete = function WebformAutocomplete(_ref) {
  ...
  var webform = useContext(WebformContext);
  useEffect(function () {
...
var WebformMultifield = function WebformMultifield(_ref) {
  ...
  var renderChildren = function renderChildren(item) {
    ...
    if (Array.isArray(compositeElements) && compositeElements.length) {
      return compositeElements.map(function (childKey) {
        ...
        // elementItem['#title_display'] = 'before';
  ...
  var _loop = function _loop(i) {
    ...
    children.push( /*#__PURE__*/jsxs("tr", _extends({}, trProps, {
      children: [/*#__PURE__*/jsx("td", _extends({}, tdProps, {
        children: renderChildren(i)
      })), /*#__PURE__*/jsx("td", _extends({}, tdProps, {
...
var WebformTable = function WebformTable(_ref) {
  ...
  return /*#__PURE__*/jsx(WebformElementWrapper, _extends({
    ...
    children: /*#__PURE__*/jsxs("table", _extends({}, fieldProps, {
      children: [/*#__PURE__*/jsx("thead", _extends({}, theadProps, {
        children: /*#__PURE__*/jsx("tr", _extends({}, trProps, {
      ...
      })), /*#__PURE__*/jsx("tbody", _extends({}, tbodyProps, {
        children: childElements
      }))]
    }))
  }));
...
var WebformRange = function WebformRange(_ref) {
  ...
  var outputElement = /*#__PURE__*/jsx("output", {
    htmlFor: element['#id'],
...
var WebformCheckbox = function WebformCheckbox(_ref) {
  ...
  var _useState = useState(value != null ? value : element['#checked'] ? element['#checked'] : false),
...
var WebformTermsOfService = function WebformTermsOfService(_ref) {
  ...
  var _useState = useState(false),
    show = _useState[0],
    setShow = _useState[1];
  var _useState2 = useState(element['#checked'] ? element['#checked'] : false),
    checkedState = _useState2[0],
    setCheckedState = _useState2[1];
  var _useState3 = useState(element['#access'] ? element['#access'] : true),
...
var WebformActions$1 = withStates(withDefaultValue(withAttributes(withWrapper(WebformActions, {
  wrapperProps: {
    style: {
      display: 'flex'
    }
...
var WebformTableRow = function WebformTableRow(_ref) {
  ...
  var _useContext = useContext(WebformContext),
    data = _useContext.data,
    setData = _useContext.setData;
  return /*#__PURE__*/jsx("tr", _extends({}, fieldProps, {
    children: getChildElements(element).map(function (key) {
      ...
      return /*#__PURE__*/createElement("td", _extends({}, _extends({}, tdProps, normalizeAttributes((_element$key$Wrapper = element[key]['#wrapper_attributes']) != null ? _element$key$Wrapper : {})), {
        key: key
...
var ConfirmationPage = function ConfirmationPage(_ref) {
  ...
  var defaultMessage = /*#__PURE__*/jsxs(Fragment, {
...
var MultiPageForm = function MultiPageForm(_ref) {
  ...
  return /*#__PURE__*/jsxs("div", {
    children: [/*#__PURE__*/jsx("ul", {
    ...
    }), /*#__PURE__*/jsx("br", {}), /*#__PURE__*/jsx("h1", {
      children: pageElement['#title']
    }), /*#__PURE__*/jsxs("h1", {
      children: ["(", currentPage + 1, "/", children.length, ")"]
      ...
      children: pageElement['#prev_button_label'] ? pageElement['#prev_button_label'] : 'Next'
    }), !showSubmitBtn && /*#__PURE__*/jsx("button", {
      style: {
        border: 'solid'
      },
      type: "button",
      ...
      children: pageElement['#next_button_label'] ? pageElement['#next_button_label'] : 'Next'
...
var defaultComponents = {
  ...
  submit: WebformActions$1,
  item: WebformItem$1,
  value: WebformValue$1,
  webform_actions: WebformActions$1,
...
var _excluded = ["data", "id", "sid", "customComponents", "onSubmit", "apiUrl", "validate"];
...
var Webform = function Webform(_ref) {
  ...
  var registerField = React.useCallback(function (name, _ref2) {
